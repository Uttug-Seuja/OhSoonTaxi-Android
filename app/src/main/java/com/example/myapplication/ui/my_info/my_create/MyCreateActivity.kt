...
class MyCreateActivity : AppCompatActivity(), MyReservesAdapter.ItemClickListener {
    private val binding by lazy { ActivityMyCreateBinding.inflate(layoutInflater) }
    private val viewModel by lazy {
        ViewModelProvider(
            this,
            MyCreateViewModel.Factory(application)
        )[MyCreateViewModel::class.java]
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launchWhenStarted {
            viewModel.toastMessage.collect { message ->
                Toast.makeText(this@MyCreateActivity, message, Toast.LENGTH_SHORT).show()
            }
        }
    ...
    private fun setObserver() {
        ...
        viewModel.reservesListReservationsRetrofit(userUid!!)
    ...
    override fun onItemClickListener(item: ReservesListResponseData, position: Int) {
        // 원하는 화면 연결
        val intent = Intent(this@MyCreateActivity, DetailActivity::class.java)
