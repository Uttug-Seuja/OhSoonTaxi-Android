...
class KakaoLocalAdapter(val itemList: ArrayList<ModelKakaoLocal>): RecyclerView.Adapter<KakaoLocalAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: KakaoLocalAdapter.ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            itemClickListener.onClick(it, position, itemList)
        }
    }
    ...
    interface OnItemClickListener {
        fun onClick(v: View, position: Int, itemList: ArrayList<ModelKakaoLocal>)
    }
